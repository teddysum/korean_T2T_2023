...
def main(args):
    ...
    train_dataloader = Table2TextDataLoader("resource/data/nikluge-gtps-2023-train.jsonl", tokenizer, args.batch_size)
    valid_dataloader = Table2TextDataLoader("resource/data/nikluge-gtps-2023-dev.jsonl", tokenizer, args.valid_batch_size)
